# scene_01_case_01_positive_basic

## 1. Case 元信息

| 字段 | 内容 |
|---|---|
| case_id | scene_01_case_01 |
...
请按图里的布局跑一遍托盘分拣停留点传送线，让物料按场景描述完成基础流程，传送带要按停留点排队，不要把物料瞬移到终点。
...
| case_user_goal | 请按图里的布局跑一遍托盘分拣停留点传送线，让物料按场景描述完成基础流程，传送带要按停留点排队，不要把物料瞬移到终点。 |
